...
**Transverse :**
7. 🔧 MI6 — QA/sécurité, à chaque phase. Portions MI0 (`QA_ROADMAP.md` §6.2) et MI2 (`QA_ROADMAP.md` §6.3) livrées ; reste à couvrir au fur et à mesure de MI3-MI5.
...
> externe). MI1 et MI2 sont faits (cf. tableau ci-dessus). Prochain prompt à
> rédiger : MI3 (vérification Wakil payante), une fois le volume payant
> confirmé avec Wassim.
