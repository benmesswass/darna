...
export const ar: Dictionary = {
  ...
  pagesLegales: {
    ...
    cgu: {
      intro:
        "شروط الاستعمال هاذي («الشروط») تنظّم الوصول لمنصة دارنا واستعمالها، وهي منصة تربط بين المسافرين/الحرفاء والمضيفين/المعلنين لكراء الإقامات والكراء طويل المدى وبيع العقارات في تونس. بإنشائك لحساب ولا استعمالك للخدمة، إنت تقبل بالشروط هاذي. [نصّ مشروع، لازمو مراجعة من محامي تونسي قبل الإطلاق الرسمي.]",
      sections: [
        {
          titre: "1. الموضوع ودور دارنا",
          corps: [
            "دارنا هي سوق للوساطة التقنية تربط بين المضيفين والمسافرين. دارنا ماهيش مالكة ولا مكرّية ولا بائعة ولا وكيلة عقارية ولا نائبة ولا منظّمة للإقامة ولا ضامنة للمستعملين.",
            "دارنا ماهيش طرف في العقود المبرمة بين المستعملين. عقد الكراء ولا البيع يتبرم حصرياً بين المضيّف والمسافر؛ ودارنا تكتفي بتوفير أدوات للبحث والربط والحجز والمراسلة واللجوء لمزوّد خلاص مرخَّص.",
          ],
        },
        {
          titre: "2. الحساب والتثبّت من الهويّة",
          corps: [
            "إنشاء الحساب يتطلّب عنوان بريد إلكتروني صحيح وكلمة سر. إنت تتعهّد بتوفير معلومات صحيحة وتحيينها والحفاظ على سرّية معطيات الدخول متاعك.",
            "التثبّت من البريد ولا الهاتف ولا الهويّة (بطاقة التعريف) يهدف لسلامة الجماعة، وماهوش ضمان لملاءة المستعمل ولا لحسن نيّتو.",
          ],
        },
        {
          titre: "3. الإعلانات ومراقبتها",
          corps: [
            "الإعلانات تتنشر تحت مسؤولية المضيّف وحدو، اللي يضمن أنو عندو الحقوق اللازمة ويحترم التراتيب المنطبقة.",
            "«مراقبة دارنا» هي تثبّت تصريحي محدود (وثائق، هويّة، وعند الاقتضاء معاينة وكيل). ماهيش ضمان ولا شهادة على وجود العقار ولا حالتو ولا مطابقتو ولا سلامتو ولا توفّرو.",
            "المسافر يبقى ملزم يتثبّت بروحو من العقار قبل الخلاص وقبل الوصول؛ والصور والأوصاف إرشادية. دارنا تنجّم ترفض ولا تعلّق ولا تسحب أي إعلان غير مطابق ولا احتيالي ولا مضلّل.",
          ],
        },
        {
          titre: "4. شبكة الوكيل",
          corps: [
            "الوكلاء شركاء مستقلّون وماهمش أُجراء عند دارنا. معاينة الوكيل هي ملاحظة واقعية وظرفية بلا التزام بنتيجة. دارنا ما تتحمّلش مسؤولية أفعال الوكلاء ولا إغفالاتهم إلا في حدود ما يفرضو القانون.",
          ],
        },
        {
          titre: "5. التقييمات والآراء",
          corps: [
            "التقييمات صادرة من المستعملين، ما تتثبّتش منها دارنا بصفة منهجية، وما تلزم كان أصحابها.",
          ],
        },
        {
          titre: "6. الخلاص",
          corps: [
            "المدفوعات الإلكترونية يتولّى معالجتها مزوّد خدمات خلاص مرخَّص. دارنا ما تحتفظش بأموال المستعملين وتاخذ كان عمولة الوساطة متاعها. المبالغ يتم احتسابها من جهة الخادم؛ وما تتستعملش أي قيمة مبعوثة من المتصفّح كمبلغ يتخلّص.",
            "الخلاص الإلكتروني ينجّم يكون تسبقة (عربون)؛ والباقي يتخلّص مباشرة بين المسافر والمضيّف. المبالغ بالدينار التونسي (TND)، والعرض باليورو مجرّد تحويل إرشادي.",
            "أي ضمان مالي (الكوسيون) يتّفق عليه ويتصرّف فيه مباشرة بين المضيّف والمسافر، خارج المنصة. دارنا ما تحتفظش بالكوسيون وما تتصرّفش فيه.",
          ],
        },
        {
          titre: "7. الإلغاء والاسترجاع",
          corps: [
            "كل إعلان يبيّن سياسة الإلغاء متاعو، اللي تلزم بين المضيّف والمسافر. الاسترجاعات، إن وُجدت، يتولّاها مزوّد الخلاص حسب هاذي السياسة.",
            "دارنا ماهيش ضامنة لخلاص الباقي ولا لتنفيذ التزامات المضيّف. حقوق المستهلك ذات النظام العام تبقى محفوظة.",
          ],
        },
        {
          titre: "8. عمولة دارنا",
          corps: [
            "دارنا تاخذ عمولة وساطة، وعاءها ونسبتها مبيّنين وقت الحجز. ممنوع الالتفاف على المنصة باش تتجنّب العمولة كي يصير الربط عبر دارنا.",
          ],
        },
        {
          titre: "9. واجبات المستعملين",
          corps: [
            "المضيّف يضمن حقّو في الكراء ولا البيع، وصحّة الإعلان، واحترام واجباتو القانونية والجبائية والتأمينية.",
            "المسافر يتعهّد باستعمال مطابق واحترام العقار ونظامو. وكل طرف يتعهّد باستعمال نزيه للمنصة واحترام التشريع التونسي الجاري بيه العمل.",
          ],
        },
        {
          titre: "10. تحديد المسؤولية",
          corps: [
            "المنصة موفّرة «كما هي» و«حسب توفّرها». دارنا ما تتحمّلش مسؤولية أفعال المستعملين ولا محتواهم، ولا حالة العقارات ولا مطابقتها، ولا النزاعات بين المضيّف والمسافر.",
            "في حدود ما يسمح بيه القانون، المسؤولية القصوى لدارنا على أي معاملة محدودة بمبلغ العمولة اللي تحصّلت عليها فعلياً. هاذي الاستثناءات ما تنطبقش في صورة الخطأ الجسيم ولا التدليس، وما تنقّصش من حقوق المستهلك ذات النظام العام.",
          ],
        },
        {
          titre: "11. الضمان والتعويض",
          corps: [
            "المستعمل يضمن دارنا ضدّ أي مطالبة من الغير ناتجة عن إعلانو ولا محتواه ولا استعمالو للمنصة.",
          ],
        },
        {
          titre: "12. الملكية الفكرية",
          corps: [
            "علامة دارنا وشعارها ونصوصها وواجهتها محمية؛ وكل استنساخ بدون ترخيص ممنوع. محتوى الإعلانات يبقى ملك أصحابو، اللي يمنحو دارنا رخصة استعمال لغرض تشغيل المنصة فقط.",
          ],
        },
        {
          titre: "13. المعطيات الشخصية",
          corps: [
            "معالجة المعطيات الشخصية مبيّنة في سياسة الخصوصية، المطابقة للقانون عدد 2004-63 المتعلّق بحماية المعطيات الشخصية.",
          ],
        },
        {
          titre: "14. القوّة القاهرة",
          corps: [
            "ما فمّاش طرف يتحمّل المسؤولية على إخلال ناتج عن حالة قوّة قاهرة.",
          ],
        },
        {
          titre: "15. التعديل والتعليق وإنهاء الخدمة",
          corps: [
            "دارنا تنجّم تعدّل الشروط هاذي؛ والنسخة المنطبقة هي اللي جارية وقت الاستعمال، مع الإعلام بالتغييرات الجوهرية.",
            "دارنا تنجّم تعلّق ولا تغلق حساب في صورة الإخلال ولا الاحتيال ولا الاستعمال التعسّفي. إنت تنجّم تغلق حسابك في أي وقت.",
          ],
        },
        {
          titre: "16. القانون المنطبق والنزاعات",
          corps: [
            "الشروط هاذي تخضع للقانون التونسي. الأطراف يلوّجو على حلّ ودّي في البداية.",
            "وإلّا، كل نزاع يرجع لاختصاص المحاكم التونسية المختصّة، مع مراعاة القواعد الإلزامية اللي تحمي المستهلكين، خاصة المقيمين في الاتحاد الأوروبي.",
          ],
        },
      ],
    },
