...
export const ar: Dictionary = {
  meta: {
    ...
    description:
      "دارنا — إقامات وعقارات في تونس. إعلانات موثّقة، أسعار شفّافة، وصفر عربون للمالك.",
  },
  nav: {
    sejours: "إقامات",
    immobilier: "عقارات",
  ...
  brand: {
    ...
    heroLine3: "صفر عربون للمالك.",
    heroSub:
      "دارنا هي أول منصة تونسية وين كل إعلان موثّق، كل سوم شفّاف، وما تخلّصش عربون للمالك أبدًا : أونلاين تخلّص غير معاليم الحجز، ويرجعولك إذا الإعلان ماكانش مطابق.",
  ...
  home: {
    ...
    verticalSejoursDesc:
      "فيلات، دور ضيافة وشقق لعطلتك — روزنامة حقيقية، تقييمات من مسافرين حقيقيين، وصفر عربون للمالك.",
    ...
    tabSejoursDesc: "فيلات ودور ضيافة للعطلة، صفر عربون للمالك.",
    tabImmoDesc: "بيع وكراء طويل المدى، مباشرة مع صاحب الملك.",
    heroQuestion: "شنوّة تلوّج عليه؟",
    diffTitle: "إقامات ولا عقارات؟",
    diffSejours:
      "للعطلة: أحجز مسكن موثوق — أونلاين تخلّص غير معاليم الحجز، بلا عربون للمالك أبدًا.",
    diffImmo:
    ...
    trust3Title: "صفر عربون للمالك",
    trust3Desc:
      "ما تخلّصش عربون للمالك أبدًا. أونلاين تخلّص غير معاليم الحجز — يرجعولك إذا الإعلان ماكانش مطابق. الإقامة تتخلّص في عين المكان، وقت الوصول.",
  ...
  auth: {
    ...
    seConnecter: "ادخل",
    sInscrire: "سجّل",
    continuerAvecGoogle: "كمّل بـ Google",
    ouSeparateur: "ولا",
  ...
  dashboard: {
    ...
    statutReservation: {
      ...
      CONFIRMEE: "مؤكّد — المعاليم متخلّصة",
      ANNULEE: "ملغى",
      TERMINEE: "مكمّل",
    } as Record<string, string>,
  ...
  admin: {
    ...
    navRemboursements: "الاسترجاعات",
    remboursementsTitre: "استرجاعات مستوجبة (عمولة دارنا)",
    remboursementsSousTitre:
      "Konnect ما فيهاش استرجاع أوتوماتيكي: كل سطر يستنى تسوية يدوية — بكريدي دارنا (فوري، الأفضل) ولا بحوالة بنكية.",
    remboursementsTotalDu: "الجملة المستوجبة",
    remboursementsVide: "ما فما حتى استرجاع في الانتظار.",
    remboursementsColVoyageur: "المسافر",
    remboursementsColAnnonce: "الإعلان",
    remboursementsColMontant: "المبلغ",
    remboursementsColAnnule: "لغى في",
    remboursementsCrediter: "زيد كريدي للحساب",
  ...
  analytics: {
    ...
    verticalesDesc:
      "نموذجان لا يُخلطان: الإقامة تقبض معاليم الخدمة أونلاين، والعقارات وساطة (عملاء محتملون، دون دفع إلكتروني).",
  ...
  email: {
    ...
    bookingConfirmHtml: (p: {
      ...
      `<p>الحجز متاعك في <strong>${p.propertyTitle}</strong> تأكّد. خلّصت معاليم الحجز متاع Darna — يرجعولك إذا السكن ماكانش مطابق للإعلان. الكراء يتخلّص كاش للمضيف وقت وصولك.</p>` +
      ...
      `<tr><td style="padding:6px 0;color:#6b7280">معاليم الحجز المخلّصة</td><td style="padding:6px 0;text-align:left;font-weight:600">${p.amountPaid}</td></tr>` +
      `<tr><td style="padding:6px 0;color:#6b7280">الباقي كاش وقت الوصول</td><td style="padding:6px 0;text-align:left;font-weight:600">${p.balanceDue}</td></tr>` +
      `<tr><td style="padding:10px 0;border-top:1px solid #e5e7eb;color:#6b7280">مجموع الإقامة</td><td style="padding:10px 0;border-top:1px solid #e5e7eb;text-align:left;font-weight:700;color:#0f766e">${p.total}</td></tr>` +
      `</table>` +
    ...
    newBookingHostHtml: (p: {
      ...
      `<p>أهلا ${p.hostName}،</p>` +
      `<p><strong>${p.guestName}</strong> جا يحجز <strong>${p.propertyTitle}</strong>. معاليم الحجز متاع Darna تخلّصت أونلاين — باش تقبض الكراء كامل كاش، وقت الوصول.</p>` +
      `<table style="width:100%;border-collapse:collapse;margin:16px 0">` +
      `<tr><td style="padding:6px 0;color:#6b7280">الدخول</td><td style="padding:6px 0;text-align:left;font-weight:600">${p.checkIn}</td></tr>` +
      `<tr><td style="padding:6px 0;color:#6b7280">الخروج</td><td style="padding:6px 0;text-align:left;font-weight:600">${p.checkOut}</td></tr>` +
      `<tr><td style="padding:6px 0;color:#6b7280">المسافرين</td><td style="padding:6px 0;text-align:left;font-weight:600">${p.guests}</td></tr>` +
  ...
  profil: {
    ...
    mdpAucunMotDePasse: "الحساب هذا يدخل بـ Google وما عندوش كلمة سرّ باش تبدّلها.",
    ...
    supprimerTitre: "احذف حسابي",
    supprimerAide:
      "إجراء نهائي: اسمك، إيميلك، تليفونك والصورة يتمحاو وتخرج من حسابك. الحجوزات والآراء القديمة متاعك تبقى تبان (بلا هويتك) باش نحترمو تاريخ الناس اللي تعاملت معاهم.",
    supprimerBouton: "احذف حسابي",
    supprimerConfirmer: "أكّد الحذف النهائي",
    supprimerAnnuler: "الغاء",
  ...
  booking: {
    ...
    paiementTitre: "خلاص معاليم الحجز",
    paiementFraisExplication:
      "أونلاين تخلّص غير معاليم الحجز متاع دارنا — يرجعولك إذا السكن ماكانش مطابق للإعلان. الكراء يتخلّص كامل كاش لصاحب الدار، وقت وصولك.",
    paiementMockInfo:
      "الخلاص عبر Konnect / Flouci قريبًا. وضع تجريبي: حتى خصم حقيقي ما يصير.",
    payerSimulation: "اخلص (تجربة)",
    paiementKonnectInfo:
      "خلاص مؤمّن عبر Konnect — كارت بنكية، e-DINAR، Flouci ولا wallet. غير معاليم الحجز اللي تتخصم.",
    ...
    paiementConfirmeDetail:
      "معاليم الحجز متاعك متخلّصة. الكراء يتخلّص كاش وقت الوصول — المضيف تعلّم. تلقى التفاصيل في « حجوزاتي ».",
    ...
    contactRevelationInfo:
      "معلومات الاتصال متاع صاحب الدار يتبعثولك كيف يفوت أجل الإلغاء المجّاني — ساعتها الحجز يولّي نهائي.",
    remboursementFraisPolitique:
      "استرجاع المعاليم يتبع سياسة الإلغاء متاع الإعلان (تبان في صفحة الإعلان) : كامل إذا لغيت بكري بالزّاف، ناقص ولا صفر بعد فوات الأجل المجّاني.",
    ...
    modeEscrowAide: "معاليم الحجز تتخلّص أونلاين، الكراء يتخلّص كاش وقت الوصول.",
  ...
  messages: {
    ...
    pourquoi1:
      "معاليم ترجع : معاليم الحجز متاعك ترجعلك إذا السكن ماكانش مطابق للإعلان. برّة المنصّة، ما فمّاش ضمان — الباب مفتوح للنصب.",
    pourquoi2:
  ...
  diaspora: {
    ...
    arg2Desc:
      "أونلاين تخلّص غير معاليم الحجز، يرجعولك إذا السكن ماكانش مطابق للإعلان — عمرك ما تخلّص عربون للكراء، يتخلّص في عين المكان. الخلاص الكامل أونلاين جاي مع الـ V2. الخلاص بالبطاقة البنكية العالمية قريبًا.",
      ...
      sections: [
        ...
        },
        {
          ...
          corps: [
            ...
            "غير معاليم الخدمة متاع دارنا (عمرها ما تكون الكراء) تتخلّص أونلاين وقت الحجز. في مرحلة العرض التجريبي، هالخلاص يكون محاكى بصفة افتراضية: ما فمّاش أي حركة مال حقيقية. كي يتفعّل الخلاص الحقيقي (Konnect)، المبلغ المخصوم يكون ديما بالدينار التونسي (TND)، والعرض باليورو هو مجرّد تحويل إرشادي. الكراء يتخلّص كامل كاش، مباشرة لصاحب الدار، وقت الوصول.",
          ],
        },
        {
          titre: "5. الاسترجاع والضمانات",
          corps: [
            "معاليم الخدمة اللي تتخلّص أونلاين ترجع حسب سياسة الإلغاء اللي يختارها صاحب الدار وتبان في الإعلان، وترجع كاملة في صورة الإلغاء من طرف صاحب الدار.",
            "ضمان عدم المطابقة : إذا السكن ماكانش مطابق للإعلان، تنجّم تبلّغ في الـ24 ساعة اللي تجي بعد وصولك. بعد الفحص من فريقنا، معاليم الخدمة ترجع كاملة إذا التبليغ اتصادق عليه.",
            "ضمان الغياب : إذا كنت صاحب دار والمسافر ماجاش، تنجّم تبلّغ في الـ48 ساعة اللي تجي بعد وقت الوصول المتوقّع؛ دارنا توّا تعوّضك بقدّ معاليم الخدمة اللي قبضتها على هالحجز، من مالها الخاص.",
            "هالضمانات تخص غير معاليم الخدمة متاع دارنا، عمرها ما تخص الكراء اللي يتخلّص مباشرة لصاحب الدار : دارنا موش شركة تأمين ولا ضامنة للكراء. أي نزاع على الكراء ولا على سير الإقامة يتسوّى مباشرة بين المسافر وصاحب الدار.",
          ],
        },
        {
          titre: "6. واجبات المستعملين",
          corps: [
      ...
      sections: [
        ...
        },
        {
          ...
          corps: [
            ...
            "معطيات قياس الجمهور الداخلي: الصفحات المتصفّحة، البحوثات اللي عملتها، تفاعلاتك مع الموقع، مرتبطة بمعرّف مجهول (كوكي darna-vid) — أبداً باسمك كي ما تكونش داخل بحسابك.",
          ],
        },
        {
          titre: "3. الأغراض",
          corps: [
            "معطياتك تُستعمل لتوفير الخدمة (الحساب، البحث، الحجز)، ولضمان الثقة والأمان (التثبّت، الوقاية من الاحتيال، التدقيق)، وللاتصال بيك بخصوص حجوزاتك، ولقياس استعمال الموقع باش نحسّنوه (إحصائيات داخلية، أبداً بروفايلينغ إشهاري).",
          ],
        },
        {
          titre: "4. الأساس القانوني",
          corps: [
            "المعالجة ترتكز على تنفيذ العقد (توفير الخدمة)، ومصلحتنا المشروعة (الأمان، الوقاية من الاحتيال، قياس الجمهور الداخلي)، واحترام الالتزامات القانونية. قياس الجمهور (القسم 5) يدخل تحت نظام الإعفاء من الموافقة متاع CNIL: ما يحتاجش موافقتك المسبقة لأن غرضه محدود بصفة صارمة للاستعمال الداخلي، بلا تقاطع مع معالجات أخرى ولا نقل لطرف ثالث.",
          ],
        },
        {
          titre: "5. الكوكيز",
          corps: [
            "كوكيز ضرورية بالقدر اللازم: جلسة الدخول، تفضيل اللغة، تفضيل العملة، وتذكّر إنك شفت شريط الإعلام بالكوكيز. لا غنى عنها باش تخدم الخدمة.",
            "كوكي قياس الجمهور الداخلي (darna-vid): معرّف مجهول، مدة حياة أقصاها 13 شهر، يتستعمل غير باش يقيس استعمال الموقع (الصفحات المتصفّحة، البحوثات) لأغراض إحصائية داخلية — أبداً ما يتقاطعش مع مواقع أخرى، أبداً ما ينتقلش لطرف ثالث، أبداً إشهاري. الكوكي هذا يدخل تحت نظام إعفاء CNIL وبالتالي ما يحتاجش موافقة.",
            "ما يتستعملش أي كوكي إشهاري ولا متتبّع طرف ثالث.",
          ],
        },
        {
          titre: "6. مدّة الحفظ",
          corps: [
            "معطيات الحساب تتحفظ ما دام حسابك نشيط.",
            "معطيات قياس الجمهور (المرتبطة بـ darna-vid) تتحفظ 25 شهر أقصى من تاريخ جمعها، طبقًا لنظام إعفاء CNIL.",
            "سجلّات التدقيق (الأمان، الوقاية من الاحتيال) تتحفظ 13 شهر.",
            "رموز التحقق (SMS، إيميل) وتوكنات إعادة تعيين كلمة السر تتمحى فور انتهاء صلاحيتها.",
            "محو أوتوماتيكي ومنتظم، بلا تدخل يدوي (job الحفظ، LANCEMENT_ROADMAP.md §L7.2).",
          ],
        },
        {
          titre: "7. الأمان",
        ...
        },
        {
          ...
          corps: [
            ...
            "تنجم تصدّر نسخة من معطياتك (البروفايل، الإعلانات، الحجوزات، الآراء، الرسائل، حركات الكريدي) بصيغة JSON في أي وقت من صفحة « البروفايل ».",
            "تنجم زادة تحذف حسابك من صفحة « البروفايل ». اسمك، إيميلك، تليفونك والصورة يتمحاو نهائياً. استثناءً لحق المحو (RGPD، الفصل 17§3)، المعطيات المرتبطة بحجز ولا فاتورة صدرت مسبقاً تبقى محفوظة بشكل مجهول الهوية عوض ما تتمحى، باش نحافظو على حقوق مستعمل آخر (مثلاً تاريخ الفواتير متاع مضيّف).",
  ...
  cookieConsent: {
    titre: "الكوكيز متاعك",
    message:
      "دارنا تستعمل كوكيز ضرورية بالقدر اللازم باش تخدم (الدخول، اللغة، العملة) وكوكي قياس جمهور داخلي، مجهول، بلا متتبّع إشهاري ولا مشاركة مع أطراف ثالثة.",
    enSavoirPlus: "اعرف أكثر",
    accepter: "فهمت",
  },
  notFound: {
