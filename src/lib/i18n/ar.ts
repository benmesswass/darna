...
export const ar: Dictionary = {
  ...
  notifications: {
    ...
    reservationAnnuleeParHote: (titre: string) =>
      `السفرة متاعك « ${titre} » تلغات من الحوت — رجعنالك الفلوس كاملة. آسفين على هذا: حسابه معلّق توّا.`,
  },
  alaUne: {
  ...
  relogement: {
    titre: "لقى مكان آخر",
    desole:
      "آسفين بصح على هذا الإلغاء — ماهوش هذا اللي نحبو نقدمولك. رجعنالك فلوسك كاملة، وعلّقنا حساب هذا الحوت على خطيته.",
    intro: (titre: string) =>
      `هاذي بعض البدائل لـ « ${titre} » الموجودة فنفس التواريخ، في نفس المدينة ولا حداها.`,
