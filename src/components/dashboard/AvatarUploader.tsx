      ...
      {image ? (
        <form action={removeAction}>
          <button
            ...
            className="flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold text-ink/60 transition hover:bg-red-50 hover:text-red-600 disabled:opacity-60"
          >
