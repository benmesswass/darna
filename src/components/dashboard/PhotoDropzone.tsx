...
export function PhotoDropzone({
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted">{fr.annonceForm.photosAccroche}</p>
      ...
      >
        ...
        <span className="text-xs text-muted">{fr.annonceForm.photosDeposerAide}</span>
      ...
      {items.length > 0 ? (
        <>
          {items.length > 1 ? (
            <p className="text-xs text-muted">{fr.annonceForm.photosReordonner}</p>
          ) : null}
      ...
      <p className="text-xs text-subtle">{fr.annonceForm.photosCreationAide}</p>
    </div>
  );
}
