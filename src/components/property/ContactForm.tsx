    ...
    <form action={action} className="space-y-3.5">
      ...
      <div className="grid gap-3.5 sm:grid-cols-2">
        <label className="block space-y-1">
          <span className="text-xs font-semibold text-ink/60">{fr.contact.nom}</span>
          <input
            name="name"
            type="text"
            required
        ...
        <label className="block space-y-1">
          <span className="text-xs font-semibold text-ink/60">{fr.contact.email}</span>
          <input
            name="email"
            type="email"
            required
      ...
      <label className="block space-y-1">
        <span className="text-xs font-semibold text-ink/60">{fr.contact.telephone}</span>
        <input
          name="phone"
          type="tel"
          required
      ...
      <label className="block space-y-1">
        <span className="text-xs font-semibold text-ink/60">{fr.contact.message}</span>
        <textarea
          name="message"
          required
          minLength={10}
